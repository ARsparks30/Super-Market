            ...
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <ul class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">Sign In or Register</li>
                    </ul>
                </div>
            </div>
        </div>
        ...
        <p class="error"> ${error} </p>
            <div class="row new-account-login">
                <div class="col-sm-6 col-lg-6 mb-3">
                    ...
                    <form  action="/loginvalidation" class="mt-3 collapse review-form-box" id="formLogin">
                        <div class="form-row">
                ...
                <div class="col-sm-6 col-lg-6 mb-3">
                    ...
                    <form action="/registration" class="mt-3 collapse review-form-box" id="formRegister">
                        <div class="form-row">
                            <div class="form-group col-md-6">
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <input type="password" class="form-control" name="password" id="InputPassword1" placeholder="Password" required> </div>
                        </div>
