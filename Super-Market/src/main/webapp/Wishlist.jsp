                ...
                <div class="col-lg-12">
                    <div class="table-main table-responsive">
                        <table class="table">
                            ...
                            <c:forEach var="cartitem" items="${wishlists}">
                            <tbody>
                                <tr>
                                    <td class="thumbnail-img">
                                        <a href="#">
									<img class="img-fluid" src="images/${cartitem.imageUrl }" alt="" />
								</a>
                                    </td>
                                    <td class="name-pr">
                                        <a href="#">
                                    ...
                                    <td class="add-pr">
                                        <a class="btn hvr-hover" href="/cartitems/${cartitem.itemName }">Add to Cart</a>
                                    </td>
                                    <td class="remove-pr">
                                        <a href="/deletewishlist/${cartitem.itemName }">
