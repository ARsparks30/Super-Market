  ...
  <!--    <div class="top-search">
        <div class="container">
            <div class="input-group">
                <a href="#"><span class="input-group-addon"> 
        ...
        <ul class="slides-container">
            <li class="text-center">
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-md-12">
                            <h1 class="m-b-20"><strong>Welcome To <br> VJ SUPER STORE</strong></h1>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="title-all text-center">
                        ...
                        <p>VJ SUPER STORES ALWAYS FRESH.</p>
                    </div>
                </div>
            </div>
            <!--<div class="row">
                ...
                <div class="col-lg-3 col-md-6 special-grid best-seller">
                    <div class="products-single fix">
                        <div class="box-img-hover">
                            ...
                            <img src="images/${item.imageUrl }" class="img-fluid" alt="Image">
                            <div class="mask-icon">
                                <ul>
                                    <!--  <li><a href="#" data-toggle="tooltip" data-placement="right" title="View"><i class="fas fa-eye"></i></a></li>
                                    <li><a href="#" data-toggle="tooltip" data-placement="right" title="Compare"><i class="fas fa-sync-alt"></i></a></li>-->
                                    <li><a href="/wishlist/${item.itemName}" data-toggle="tooltip" data-placement="right" title="Add to Wishlist"><i class="far fa-heart"></i></a></li>
                                </ul>
                                <a class="cart" href="/cartitems/${item.itemName}">Add to Cart</a>
                            </div>
                        </div>
                        <div class="why-text">
                            <h4>${item.itemName}</h4>
                            <h5> <a class="cart" href="/buynow/${item.itemName}">&#8377 ${item.itemPrice}</a></h5>
                        </div>
                    </div>
                </div>
                </c:forEach>
