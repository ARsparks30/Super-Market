            ...
            <div class="row">
                <div class="col-sm-6 col-lg-6 mb-3">
                    <div class="checkout-address">
                        ...
                        <form  action="/userdetails" class="needs-validation" novalidate>
                            <div class="row">
                          ...
                          <!--   <div class="mb-3">
                            ...
                            <div class="mb-3">
                                ...
                                <div class="input-group">
                                    <input type="password" class="form-control" name="password" id="username" placeholder="" required>
                                    <div class="invalid-feedback" style="width: 100%;"> Your password  is required for login. </div>
                                </div>
                            </div>
                            <div class="mb-3">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-3 mb-3">
                                    ...
                                    <input type="text" maxlength="6" class="form-control" id="zip" placeholder="" required>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="text" class="form-control" name="cardNumber" id="cc-number" maxlength = "16" placeholder="" required>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-3 mb-3">
                                    ...
                                    <input type="text" class="form-control" maxlength="3" name="cardCvv" id="cc-cvv" placeholder="" required>
                            ...
                            <button type="submit" class="sub btn hvr-hover">Save Details</button>
                            <hr class="mb-1">
                             </form>
                    </div>
                </div>
                <div class="col-sm-6 col-lg-6 mb-3">
                    <div class="row">
                       ...
                       <!--   <div class="col-md-12 col-lg-12">
                        ...
                        <div class="col-12 d-flex shopping-box"> <a href="/orderplaced" class="ml-auto btn hvr-hover">Place Order</a> </div>
                    </div>
                </div>
            </div>
